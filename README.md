...
![E1](./screenshots/E1_supreme_pizza_insert.png)
...
- MySQL restriction: a `TEMPORARY` table cannot be referenced twice in the same query — 
  switched to regular tables to solve this
